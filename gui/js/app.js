...
function getRandomBookDto() {
    return `{
        ...
        "authorFirstName": "${AUTHOR_FIRSTNAMES[Math.floor(Math.random() * 15)]}", 
        "authorLastName": "${AUTHOR_LASTNAMES[Math.floor(Math.random() * 15)]}"
    }`;
}
        ...
        return `<div class="col-lg-3">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <h5 class="card-subtitle mb-2 text-muted">${book.authorFirstName} ${book.authorLastName}</h5>
